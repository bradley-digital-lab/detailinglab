      ...
      <div className="grid md:grid-cols-2 gap-12">
        ...
        <div className="flex flex-col justify-center items-center bg-[#020202] rounded-2xl p-8 border border-white/5 relative overflow-hidden">
           ...
           <button 
             ...
             className="mt-6 px-8 py-3.5 bg-gradient-to-tr from-cyan-600 to-cyan-400 hover:from-cyan-500 hover:to-cyan-300 text-white font-black uppercase tracking-widest text-xs rounded-xl transition-all w-full relative z-10 shadow-[0_0_40px_rgba(6,182,212,0.4)] hover:shadow-[0_0_60px_rgba(6,182,212,0.6)] border border-cyan-400/50 hover:border-cyan-300"
           >
             Get Booked In!
           </button>
        </div>
